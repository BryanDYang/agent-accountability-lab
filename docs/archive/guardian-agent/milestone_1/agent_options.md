...
2. A separate governance layer between an AI agent application and the information that enters its context, covering both build-time and runtime use cases.
